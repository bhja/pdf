			...
			<fo:page-sequence master-reference="main">
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:table   width="8.27in" height="11.69in" >
						...
						<fo:table-body background-image="classpath:static/images/AnimalReport/MainPage8.jpg"   background-repeat="no-repeat" background-position="center"  padding-left="0.0mm" >
						...
						<fo:table-body>
							<fo:table-row>
										...
										<fo:table-body>
											<fo:table-row>
												<fo:table-cell text-align="left" font-family="Lucida Sans Unicode,Lucida Grande,sans-serif" padding-top="0.1in">
													<fo:external-graphic  src="classpath:static/images/AnimalReport/urbanlogosmall4.jpg" width="1in" height="1in" ></fo:external-graphic>
												</fo:table-cell>
								...
								<fo:table-cell  text-align="right" >
									<fo:block><fo:external-graphic  src="classpath:static/images/AnimalReport/dogwithchildren.jpg" ></fo:external-graphic></fo:block>
								</fo:table-cell>
							</fo:table-row>
										...
										<fo:table-body>
											<fo:table-row >
												...
												<fo:table-cell align="bottom">
													<fo:block  color="#0070C0"  font-weight="bold"><fo:external-graphic  src="classpath:static/images/AnimalReport/doghexagonreddish3.jpg" width="0.62in" height="0.7in"  ></fo:external-graphic>
													</fo:block>
												</fo:table-cell>
						...
						<fo:table-body >
							<fo:table-row  >
								<fo:table-cell text-align="left" font-family="Arial, Helvetica, sans-serif" padding-top="0.5in">
									<fo:external-graphic  src="classpath:static/images/AnimalReport/doghexagonreddish3.jpg" width="0.62in" height="0.7in"></fo:external-graphic>
								...
								<fo:table-cell  text-align="right" >
									<fo:block><fo:external-graphic  src="classpath:static/images/AnimalReport/urbanlogosmall4.jpg" width="1in" height="1in" ></fo:external-graphic></fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-body>
					</fo:table>
						...
						<fo:table-body>
							...
							<fo:table-row line-height="0.19in">
								...
								<fo:table-cell padding-top="2in" padding-left="3in">
									<fo:block><fo:external-graphic  src="classpath:static/images/AnimalReport/dogkidnew.jpg"  width="4in" height="4in" ></fo:external-graphic></fo:block>
								</fo:table-cell>
							</fo:table-row>
				...
				<fo:flow flow-name="xsl-region-body">
					...
					<fo:table text-align="left"  width="7.5in" padding-top="0.25in" >
						...
						<fo:table-body >
							<fo:table-row  >
								<fo:table-cell text-align="left" font-family="Arial, Helvetica, sans-serif" padding-top="0.5in">
									<fo:block  ><fo:external-graphic  src="classpath:static/images/AnimalReport/doghexagonreddish3.jpg" width="0.62in" height="0.7in" ></fo:external-graphic>
									</fo:block>
								</fo:table-cell>
